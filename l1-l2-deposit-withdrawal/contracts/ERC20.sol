...
contract ERC20 {
     ...
     * @param _decimals Number of decimals for our ERC20.
     */
    constructor(
    ...
    {
        decimals = _decimals;
        balances[msg.sender] = _initialSupply * (10 ** uint256(_decimals));
    ...
    /** 
     * Allows the owner to mint more tokens for a given account.
     * @param _receiver Address to mint tokens for.
